...
function adjustStyle() {
	handlePreferredScreenSize(function (screenValue) {
		if (screenValue === "xlarge" || screenValue === "large" || screenValue === "web") {
...
function panelMenu(divId) {
	...
	*/
	panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#indexPage"><img src="./images/icons/recent_post_shadow2.png" class="ui-li-icon largerIcon">Summary</a></li>');
	//panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#NewComplaintSectionPage"><img src="./images/icons/newcomplaint.png" class="ui-li-icon largerIcon">New Complaint</a></li>');
	//panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#mypost"><img src="./images/icons/mypost.png" class="ui-li-icon largerIcon">My Post</a></li>');
	panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#historyPage"><img src="./images/icons/history.png" class="ui-li-icon largerIcon">All Post</a></li>');
	//panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#eventsPage"><img src="./images/icons/event.png" class="ui-li-icon largerIcon">Events</a></li>');
	panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#profilePage"><img src="./images/icons/login.png" class="ui-li-icon largerIcon">My Profile</a></li>');
	panel.append('<li data-icon="false" ' + addon +'><a class="panelText" ' + addon2 +' href="#aboutPage"><img src="./images/icons/ic_action_info.png" class="ui-li-icon largerIcon">About</a></li>');
...
function panelMenuLeftOpened() {
	...
	if (window.localStorage.getItem("pageNaveType") === "menu") {
		...
		if (currentId === "Index") {
			$("#headerTitle" + currentId).attr("src", "./images/icons/ic_main_menu_launcher.png");
		}
